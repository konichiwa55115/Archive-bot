...
def enter_files(_, msg: types.Message):
    ...
    with db_session:
        ...
        if usr.status == 1:  # check if user-status is "INSERT"
            ...
            if type.file_size > 999999999999999999999999999999999999999999999999999999999999999999:
                msg.reply(Msg.too_big)
            elif len(list_dir(uid)) > 9999999999999999999999999999999999999999999999999999999999999:
